...
public class Hello {
    public static void main( String[] args) throws Exception {
        ValidCodeApi api = new ValidCodeApi();
        String app_id = "305194";
        String app_key = "bcYTM+dXdMWumHtdWCucksQlvEtXG74J";
        String pd_id = "105194";
        String pd_key = "mV+SRFEgmbIHqETBZouMTwdj/BrGPivA";
        ...
        String img_file = "D:\\validcode\\vPwj.jpg";
